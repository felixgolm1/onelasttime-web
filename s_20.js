  ...
  function tick() {
    ...
    if (oryzoSec && oryzoTxtL && oryzoTxtR && oryzoDeck) {
      ...
      if (deckClone) {
         ...
         if(deckClone) {
           let iCardsWrap = deckClone.querySelector('.interior-cards');
           if (iCardsWrap) {
               iCardsWrap.style.opacity = eOpen === 0 ? '0' : '1';
           }
     ...
     var endCardTable = window._endCardTable;
         ...
         if (localP >= 2.2) {
           ...
           if(eRev4){if(localP>8.32&&localP<9.92){var eRp4=mapRange(localP,8.32,9.92,0,1);eRev4.style.transform='translateY('+mapRange(localP,8.32,9.92,window.innerHeight*1.5,-window.innerHeight*1.5)+'px)';eRev4.style.opacity=eRp4>0.85?mapRange(eRp4,0.85,1.0,1,0):1; updateReviewPanelInternals(eRev4, eRp4);}else eRev4.style.opacity='0';}
            ...
            (function(){
              ...
              if (localP >= IS_ENTER) {
                ...
                if (localP <= IS_CENTER) {
                  ...
                  if (_oltPhaseDyn) {
                      ...
                      if (dynRow && counterSpan && strikeLine && counterContainer) {
                          ...
                          if (dpLeft && dpRight) {
                              var maxWLeft = 600; 
                              var maxWRight = 50; // Increased to ensure it fits the whole sentence
                  ...
                  if (localP > EARLY_FADE_START) {
                      if (magClone) magClone.style.display = 'none';
                      ...
                      if (window.polaroidPhotoMat) {
                          ...
                          if (pVid && pVid.duration) {
                              // El video empieza en locP 31.0 y termina en 34.0 (3.0 unidades)
                              let vidProg = Math.max(0, Math.min(1, (localP - 31.0) / 3.0));
                  ...
                  if (localP > START_3D_REVEAL) {
                      ...
                      var magClone2 = document.getElementById('mag-model-clone');
                      if (magClone2) magClone2.style.display = '';
                  ...
                  var easeConverge = convergeP * (2 - convergeP); window._isFinalCtaCentered = (localP >= 40.0);
                  ...
                  if (localP < 39.0) {
                      ...
                      if (_oltCtaBig) {
                          ...
                          _oltCtaBig.style.transform = 'translateY(' + ((1 - _exitEA) * 100).toFixed(2) + 'vh) translate(var(--mx, 0px), var(--my, 0px))';
                      }
                  } else {
                      ...
                      if (_oltCtaBig) {
                          _oltCtaBig.style.transform = 'translateY(' + (-easeConverge * 30) + 'vh) translate(var(--mx, 0px), var(--my, 0px))';
                ...
                if (_ulReset) _ulReset.style.transform = 'scaleY(0)';
                  ...
                  if (_oltCtaR) {
                      _oltCtaR.style.transform = 'translateY(100vh) translate(var(--mx, 0px), var(--my, 0px))';
            ...
            var _oltC = document.getElementById('olt-final-cta'); if (_oltC) { _oltC.style.transform = 'translateY(100vh) translate(var(--mx, 0px), var(--my, 0px))'; _oltC.style.opacity = '0'; _oltC.style.pointerEvents = 'none'; }
