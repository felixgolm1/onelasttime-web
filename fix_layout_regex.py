...
new_ai = '''    <div id="made-by-ai" style="position: fixed; top: 50%; left: 50%; font-family: 'Inter', sans-serif; font-size: clamp(2.5rem, 8vw, 10rem); font-weight: 700; color: #f4f2ea; letter-spacing: -0.05em; white-space: nowrap; opacity: 1; z-index: 10001; pointer-events: none; visibility: hidden;">
      <span style="position: relative; display: inline-block;">
        <span style="position: absolute; right: 100%; top: 52%; transform: translateY(-50%) rotate(-90deg); margin-right: 0.1em; display: flex; justify-content: space-between; font-size: 0.18em; font-weight: 600; letter-spacing: 0; color: #c1ff00; opacity: 0.9; width: 4.1em;">
      ...
      <span style="color: #c1ff00; position: relative; display: inline-block;">
        IA
        <span style="position: absolute; left: 0; top: 96%; display: flex; justify-content: space-between; font-size: 0.155em; font-weight: 700; letter-spacing: 0; width: 100%; white-space: nowrap; color: #c1ff00;">
