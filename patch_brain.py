...
# 4. Scroll logic insertion
# We find: `lineR.setAttribute('y2', `${100 - (100 * dashP)}%`);\n        }`
# And insert our portal + brain logic
...
scroll_logic = """
        ...
        if (portalP > 0) {
            ...
            if (window.brainPivot) {
                ...
                // Text stages:
                // Stage 1 (Small talk): heatP 0 to 0.33
                // Stage 2 (Profundizando): heatP 0.33 to 0.66
                // Stage 3 (Profundo): heatP 0.66 to 1.0
                if (heatP < 0.33) {
