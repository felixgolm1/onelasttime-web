...
new_ai = '''      <div id="made-by-ai" style="position: fixed; top: 50%; left: 50%; font-family: 'Inter', sans-serif; font-size: clamp(2.5rem, 8vw, 10rem); font-weight: 700; color: #f4f2ea; letter-spacing: -0.05em; white-space: nowrap; opacity: 1; z-index: 10001; pointer-events: none; visibility: hidden;">
      <span style="position: relative; display: inline-block;">
        <span style="position: absolute; right: 100%; top: 48%; width: 0; height: 0;">
          <span style="position: absolute; right: 0.08em; top: 50%; transform: translateY(-50%) rotate(-90deg); display: flex; justify-content: space-between; font-size: 0.18em; font-weight: 600; letter-spacing: 0; color: #f4f2ea; opacity: 0.9; width: 4.1em; transform-origin: center right;">
      ...
      <span style="color: #c1ff00; position: relative; display: inline-block;">
        IA
        <span style="position: absolute; left: 5%; top: 82%; display: flex; justify-content: space-between; font-size: 0.13em; font-weight: 700; letter-spacing: 0; width: 92%; white-space: nowrap; color: #c1ff00;">
